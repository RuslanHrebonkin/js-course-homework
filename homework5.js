...
setTimeout(anyway,1000);

//2. Напишите функцию slep(ms) должна возвращать промис, который перейдёт в состояние «выполнен» через ms миллисекунд
function sleep(ms) {
...
//3. Измените функцию так, чтобы она возвращала промис:
 ...
 function getText(success, error) {
       return new Promise((resolve,reject) =>{
        ...
        link = 'https://ww---w.w3.org/TR/PNG/iso_8859-1.txt'
